...
export function Hero({ smoothScrollTo }: { smoothScrollTo: (id: string) => void }) {
  return (
    <section
      id="home"
      className="h-[420px] md:h-[520px] w-full rounded-2xl overflow-hidden bg-center bg-cover relative"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white/85">
